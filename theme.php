 ...
 * Name: Talkplus
 * Version: 0.1
 * Author: kris <http://friendi.talkplus.org/profile/kris>
 * Description: Talkplus is based on the default theme (duepuntozero) with small improvments. The goal is to improve the user experience of new and old users. Friendica should be easy to use and why not beautifull. 2015-11
 */
function talkplus_init(&$a) {
